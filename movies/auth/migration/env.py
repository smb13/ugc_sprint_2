...
# sys.path.append(os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), os.pardir))  # noqa: E800
...
config.set_section_option(section, "POSTGRES_DB", settings.postgres_auth_db)
